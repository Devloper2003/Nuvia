...
const FEATURES: Feature[] = [
  ...
  { id: 'f5', title: 'Meditation Library', description: '200+ guided sessions for stress, sleep, and hormonal balance', icon: Moon, gradient: 'from-violet-400 to-purple-500' },
  ...
  { id: 'f7', title: 'Doctor Consultations', description: 'Video consults with verified gynecologists & specialists', icon: Stethoscope, gradient: 'from-teal-400 to-teal-600' },
  { id: 'f8', title: 'Advanced Reports', description: 'Comprehensive health reports you can share with your doctor', icon: FileBarChart, gradient: 'from-plum-soft to-plum' },
  { id: 'f9', title: 'Ad-Free Experience', description: 'Enjoy an uninterrupted, distraction-free wellness journey', icon: Ban, gradient: 'from-rose-300 to-rose-400' },
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="text-sm font-semibold text-foreground flex items-center gap-2">
          Premium is active
          <Badge className="bg-gradient-to-r from-amber-500 via-yellow-500 to-orange-500 text-plum border-0 text-[9px] h-4 px-1.5">
            PAYPAL SANDBOX
          </Badge>
        </p>
  ...
  return (
    <div className="min-h-screen">
      ...
      <motion.section
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="card-plum relative mb-8"
      >
        {/* Decorative blurs */}
        ...
        <div className="relative z-10 p-6 sm:p-8 lg:p-12 text-center text-white">
          <motion.div
            ...
            className="inline-flex items-center gap-2 rounded-full bg-plum-soft/50 backdrop-blur-md px-4 py-1.5 text-sm font-semibold mb-5 border border-gold/40 text-gold"
          >
          ...
          <motion.h1
            ...
            className="gold-shine font-serif text-3xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-4"
          >
          ...
          <motion.span
            ...
            className="gold-divider text-[10px] mb-4"
            aria-hidden
          >
            <span>✦</span>
          </motion.span>
      ...
      <section className="mb-12">
        <div className="text-center mb-6">
          <h2 className="font-serif text-2xl sm:text-3xl font-bold tracking-tight mb-2">Choose Your Plan</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-6 max-w-5xl mx-auto pt-6">
          {PLANS.map(plan => (
      ...
      <section className="mb-12">
        <div className="text-center mb-8">
          <Badge variant="secondary" className="mb-2 bg-gold-soft text-plum">
            <Zap className="h-3 w-3 mr-1 text-amber-500" /> Premium Features
          </Badge>
          <h2 className="font-serif text-2xl sm:text-3xl font-bold tracking-tight mb-2">Everything You Need to Thrive</h2>
            ...
            >
              <Card className="h-full hover:shadow-md transition-shadow">
                <CardContent className="p-4">
                  <div className={cn('flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br text-white shadow-sm mb-3', feature.gradient)}>
      ...
      <section className="mb-12">
        <div className="text-center mb-8">
          <Badge variant="secondary" className="mb-2 bg-blush text-primary">
            <Heart className="h-3 w-3 mr-1" /> Loved by Thousands
          </Badge>
          <h2 className="font-serif text-2xl sm:text-3xl font-bold tracking-tight mb-2">Stories From Our Community</h2>
            ...
            >
              <Card className="h-full overflow-hidden hover:shadow-md transition-shadow">
                <CardContent className="p-5 flex flex-col h-full">
                  <Quote className="h-7 w-7 text-gold/60 mb-2" />
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5">
                        ...
                        <Badge variant="secondary" className={cn('text-[9px] h-4 px-1.5 gap-0.5', t.plan === 'Premium Plus' ? 'bg-purple-100 text-purple-700 dark:bg-purple-950/40 dark:text-purple-300' : 'bg-gold-soft text-plum')}>
      ...
      <section className="mb-12 max-w-3xl mx-auto">
        <div className="text-center mb-8">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl font-bold tracking-tight">Frequently Asked Questions</h2>
        </div>
      ...
      <section className="mb-8">
        <Card className="overflow-hidden border-gold/30">
          <div className="bg-gold-soft/40">
            <CardContent className="p-5">
              <div className="text-center mb-4">
                <h3 className="font-serif text-base font-semibold flex items-center justify-center gap-2">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
                {TRUST_BADGES.map(badge => (
                  <div key={badge.id} className="flex flex-col items-center text-center p-3 rounded-lg bg-card/60 border border-border/50 hover:border-gold/50 transition-colors">
                    <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gold-soft text-amber-600 dark:text-amber-400 mb-2">
      ...
      <motion.section
        ...
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="card-plum relative mb-4"
      >
        <div className="absolute -top-10 -right-10 h-40 w-40 rounded-full bg-gold/25 blur-3xl" />
        <div className="absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-fuchsia-500/20 blur-3xl" />

        <div className="relative z-10 p-8 sm:p-10 text-center">
          <Crown className="h-10 w-10 mx-auto mb-3 text-gold" />
          <h2 className="gold-shine font-serif text-2xl sm:text-3xl font-bold tracking-tight mb-2">Ready to Transform Your Health?</h2>
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Button
              ...
              className="rounded-full bg-gradient-to-r from-amber-400 via-yellow-500 to-orange-500 px-6 text-plum shadow-md shadow-amber-500/30 hover:opacity-90 font-semibold min-h-11"
            >
